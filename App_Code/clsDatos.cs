...
using System.Threading.Tasks;
    ...
    public class clsDatos
    {
        ...
        {
            get { return String.IsNullOrEmpty(_ConectionString) ? ConfigurationManager.ConnectionStrings["ConexionSQL"].ConnectionString : _ConectionString; }
        ...
        public bool OpenConection()
        {
            ...
            try
            {
                ...
                {
                    oCon.ConnectionString = ConectionString;
                    oCon.Open();
                }
                returnValue = true;
            }
